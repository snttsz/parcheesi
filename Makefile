...
Parcheesi: $(OBJDIR)/parcheesi.$(OBJEXT) $(OBJDIR)/game.$(OBJEXT) $(OBJDIR)/board.$(OBJEXT) $(OBJDIR)/gameLogic.$(OBJEXT) $(OBJDIR)/gameStruct.$(OBJEXT) $(OBJDIR)/string_util.$(OBJEXT) $(OBJDIR)/socket.$(OBJEXT)
	$(CC) $(CFLAGS) -o Parcheesi $(OBJDIR)/parcheesi.$(OBJEXT) $(OBJDIR)/game.$(OBJEXT) $(OBJDIR)/board.$(OBJEXT) $(OBJDIR)/gameLogic.$(OBJEXT) $(OBJDIR)/gameStruct.$(OBJEXT) $(OBJDIR)/string_util.$(OBJEXT) $(OBJDIR)/socket.$(OBJEXT)
...
$(OBJDIR)/gameLogic.$(OBJEXT): src/game/gameLogic.c src/game/gameLogic.h src/game/gameStructure.h | $(OBJDIR)
	$(CC) $(CFLAGS) -c src/game/gameLogic.c -o $(OBJDIR)/gameLogic.$(OBJEXT)

$(OBJDIR)/gameStruct.$(OBJEXT): src/game/gameStructure.c src/game/gameStructure.h | $(OBJDIR)
	$(CC) $(CFLAGS) -c src/game/gameStructure.c -o $(OBJDIR)/gameStruct.$(OBJEXT)
